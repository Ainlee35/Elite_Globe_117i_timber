...
export default function ProductDetails() {
  ...
  const [selectedType, setSelectedType] = useState(product?.types?.[0]?.label || "");
            ...
            <div className="mt-6">
              ...
              <div className="mt-2 flex items-center gap-3">
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-md border transition-colors hover:bg-secondary"
                >
