...
export const products: Product[] = [
  ...
  {
    id: "10",
    name: "Lexture Premium Rough Plaster",
    category: "paints",
    types: [
      { value: "white", label: "White", priceModifier: 0 },
      { value: "cream", label: "Cream", priceModifier: 3000 },
      { value: "grey", label: "Grey", priceModifier: 3000 },
    ],
    price: 45000,
    description: "Lexture Paint Premium Rough Plaster – 30KG bucket. High-quality textured plaster finish for exterior and interior walls. Provides a durable, weather-resistant rough texture coating.",
    image: "/assets/lexture-rough-plaster.png",
    inStock: true,
  },
  {
    id: "11",
    name: "Lexture Silk Emulsion Paint",
    category: "paints",
    types: [
      { value: "white", label: "Brilliant White", priceModifier: 0 },
      { value: "ivory", label: "Ivory", priceModifier: 2000 },
      { value: "peach", label: "Peach", priceModifier: 2000 },
      { value: "sky-blue", label: "Sky Blue", priceModifier: 2500 },
    ],
    price: 32000,
    description: "Lexture Paint Silk Emulsion – smooth, washable interior paint with a luxurious silk finish. Low odor, easy to apply. Coverage: 12-14 sq meters per liter.",
    image: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=600&h=400&fit=crop",
    inStock: true,
  },
  {
    id: "12",
    name: "Lexture Weather Guard Exterior",
    category: "paints",
    types: [
      { value: "white", label: "Pure White", priceModifier: 0 },
      { value: "sandstone", label: "Sandstone", priceModifier: 3000 },
      { value: "terracotta", label: "Terracotta", priceModifier: 3500 },
    ],
    price: 40000,
    description: "Lexture Paint Weather Guard – premium exterior wall paint with advanced UV and rain protection. Long-lasting color retention for tropical climates.",
    image: "https://images.unsplash.com/photo-1562259929-b4e1fd3aef09?w=600&h=400&fit=crop",
    inStock: true,
  },
  {
